                ...
                <div className=" w-full flex justify-center gap-24 items-center ">
                    ...
                    <div className=" bg-[#82498c] bg-opacity-40 p-5 shadow-2xl rounded w-[80%] xs:w-full sm:min-w-[400px]">
                        <div className=" flex flex-col justify-center items-center gap-5">
                            <button onClick={async () => await signIn('google')} disabled={loader} className=" disabled:ring-1 disabled:bg-transparent hover:bg-transparent hover:ring-1 hover:text-white ring-gray-300 flex justify-center items-center gap-3 w-full rounded shadow-sm px-6 py-2 bg-white text-black font-semibold" type="button">
